...
const SearchDayCount = () => {
    ...
    return (
        <div className='searchday-count flex items-center justify-between bg-[#122036] px-[30px] py-5 rounded-t-md shadow-lg shadow-gray-900  relative'>
            <TopupModal showModal={showModal} setShowModal={setShowModal} />
            <h2 className='font-semibold text-light text-lg'>Search Days Remaining: 0</h2>
