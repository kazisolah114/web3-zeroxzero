    ...
    return (
        <div className='free-coins'>
            ...
            <div className='text-center'>
                <h2 className='text-3xl font-bold text-light mb-3'>Earn 0x0 Token for Free</h2>
                <AppSectionHeader details={"Follow The Easy Steps Below To Claim Your Free 0x0 Tokens"} />
            </div>
