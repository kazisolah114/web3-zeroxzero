    ...
    return (
        <div className='features-section py-24 container' data-aos="flip-left"
         data-aos-duration="1000">
            <SectionHeader sectionTitle={"Our Amazing Features"} sectionDesc={"Lorem ipsum dolor semet is a world class game ipsum leto Lorem ipsum dolor semet is a world class game ipsum leto lorem"} />
