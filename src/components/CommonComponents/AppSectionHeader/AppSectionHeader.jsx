        ...
        <div className="leaderboard-header text-center mb-10">
            ...
            {defaultBtn && secondBtn &&
                <div className="toggler mt-10 mx-auto bg-[#122036] w-[fit-content] p-[5px] rounded-full flex justify-between items-center">
                    ...
                    <button onClick={() => handleSelectedButton("weekly")} className={`text-secondary ${selectedButton == "weekly" && "bg-white"} rounded-full w-40 px-2 py-[10px] font-semibold transition duration-300 ease-in-out`}>{secondBtn}</button>
                </div>
            }
        </div>
    );
